source ~/root/bin/thisroot.sh 
 ...
 export EUDAQ=/home/lcd/CLIC_Testbeam_August2013/eudaq
 export TPPROD=$EUDAQ/TimepixProducer
 export LD_LIBRARY_PATH=$EUDAQ/bin:$LD_LIBRARY_PATH 
 export LD_LIBRARY_PATH=$EUDAQ/TimepixProducer/Pixelman_SCL_2011_12_07:$LD_LIBRARY_PATH 
